...
# ╔═╡ c12de372-f069-11eb-2c6e-fbbf708dc9d2
using Flux, Plots
...
# ╔═╡ 1e1b5c68-b6ad-4c22-b7fb-7fbe2d3be602
x=5

# ╔═╡ daed3792-08a2-48b2-b044-3555fc6b1351
f(x)

# ╔═╡ 32240c3e-08cf-4203-9e81-39e5a1ac135c
gradient(f, x)

# ╔═╡ c73eb801-5e60-4f23-a267-a1cc80f127a0
begin
	plot(f, -5:5)
	plot!(x->gradient(f,x)[1], -5:0.1:5)
end
