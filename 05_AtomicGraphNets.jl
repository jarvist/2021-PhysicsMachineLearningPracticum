...
# ╔═╡ 4ff3d290-0746-11ec-2e5e-a7118e23f435
begin
...
# ╔═╡ 78298710-74f5-4467-884c-6de10a67848c
md"""
# formation_energy.jl

From https://github.com/Chemellia/AtomicGraphNets.jl/blob/main/examples/1_formation_energy/formation_energy.jl 
"""

# ╔═╡ 7276393d-23b4-4ffa-a295-7fd2a2175ac4
begin
	    num_pts = 100
	    num_epochs = 5
...
# ╔═╡ 5406271a-8145-435c-a66f-dd4083450bb0
begin
...
# ╔═╡ f0060848-b14a-4d7e-829e-defeac859a6e
...
# ╔═╡ ac8c703f-551d-43ae-bcc9-5a0a360842c9
    num_features =
...
# ╔═╡ c02d0320-e7a7-47e4-b5f8-5d76b97bbf34
begin
...
# ╔═╡ 8d531a21-516c-487b-9dd4-8c2d435c8bcc
y = Array(Float32.(info[!, Symbol(prop)]))

# ╔═╡ 6509c866-6918-4f71-95e1-d592acf9f0ba
    inputs = FeaturizedAtoms[]


# ╔═╡ 7e94f706-a2a2-4c0a-820f-ebbc2c672cd2
...
# ╔═╡ 423c5e2e-800b-42ec-8456-935e5c9f8a82
train_output = output[1:num_train]

# ╔═╡ 69a462f1-9888-49db-8c15-330135ffad32
test_output = output[num_train+1:end]

# ╔═╡ c90c1842-535c-4a58-b683-be4c5a6d3595
train_input = inputs[1:num_train]

# ╔═╡ 01379fb1-3113-47df-add3-1ed0171dcc45
test_input = inputs[num_train+1:end]

# ╔═╡ 28a6236b-6057-4566-b1c9-343428f6e24f
train_data = zip(train_input, train_output)

# ╔═╡ f8cc645e-4476-4bba-89c5-7ffb023cfde5
    model = build_CGCNN(
        num_features,
        num_conv = num_conv,
...
# ╔═╡ 66575ba1-5c0f-4899-90a9-2b7159859127
begin
...
# ╔═╡ 55eab98e-ad4d-41b2-8b5f-963acf266ce1
...
# ╔═╡ 3b38912b-cc85-4a13-8162-46f1647c12a8
begin
...
# ╔═╡ ad5a7cb2-3a0d-49a4-8d5e-2580532aef43
...
[compat]
AtomicGraphNets = "~0.2.0"
CSV = "~0.8.5"
ChemistryFeaturization = "~0.4.2"
DataFrames = "~1.2.2"
Flux = "~0.12.6"
"""
...
[[AtomicGraphNets]]
deps = ["CSV", "ChemistryFeaturization", "DataFrames", "DelimitedFiles", "Flux", "LightGraphs", "LinearAlgebra", "Random", "SimpleWeightedGraphs", "SparseArrays", "Statistics", "Zygote"]
git-tree-sha1 = "befa3d68edac552dde2d1d5eb064da2ef31ee89f"
...
git-tree-sha1 = "4ecaf28712fb7576357abc3d3b3604e4564902ce"
...
deps = ["CSV", "Colors", "Compose", "Conda", "DataFrames", "DataStructures", "Flux", "GraphPlot", "JSON", "LightGraphs", "LinearAlgebra", "PyCall", "Serialization", "SimpleWeightedGraphs"]
git-tree-sha1 = "622fcf1e435214539e6c162a3eb4c826ce3c1a8b"
...
git-tree-sha1 = "003840ce54ae0d16ecd341ded25db90a3ed2f153"
